...
public class ListSpendingCommand extends Command {

    public static final String COMMAND_WORD = "spending";
    private final String[] arguments;

    public ListSpendingCommand(String[] fullCommands) {
        this.arguments = fullCommands;
    }

    /**
     * Executes the list spending command with the given arguments
