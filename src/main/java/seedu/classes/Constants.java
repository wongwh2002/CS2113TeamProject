...
public class Constants {
    ...
    public static final String SELECT_TIME_RANGE_MESSAGE_SPENDINGS = "List spending entries within:" + System.lineSeparator() +
            "\t[1] All" + System.lineSeparator() + "\t[2] This week" + System.lineSeparator() +
            "\t[3] Past 2 weeks" + System.lineSeparator() + "\t[4] This month";
    public static final String SELECT_TIME_RANGE_MESSAGE_INCOMES = "List income entries within:" + System.lineSeparator() +
            "\t[1] All" + System.lineSeparator() + "\t[2] This week" + System.lineSeparator() +
            "\t[3] Past 2 weeks" + System.lineSeparator() + "\t[4] This month";
