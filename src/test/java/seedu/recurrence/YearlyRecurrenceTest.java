...
public class YearlyRecurrenceTest {
    ...
    public void checkSpendingRecurrence_addRecurringPastYearlyEntry_spendingListUpdated() {
        spendings.add(new Spending(10, "food", TODAY.minusYears(1), "", RecurrenceFrequency.YEARLY,
                TODAY.minusYears(1), TODAY.minusYears(1).getDayOfMonth()));
        spendings.updateRecurrence();
        commandInputForTest("list", incomes, spendings);
        assertEquals(TAB + "Spendings" + NEXT_LINE +
                TAB + "1. food - 10 - " + TODAY.minusYears(1) + " - Recurring: YEARLY"
    ...
    public void checkIncomeRecurrence_addRecurringPastYearlyEntry_incomeListUpdated() {
        incomes.add(new Income(100000, "salary", TODAY.minusYears(1), "", RecurrenceFrequency.YEARLY,
                TODAY.minusYears(1), TODAY.minusYears(1).getDayOfMonth()));
        ...
        assertEquals(TAB + "Spendings" + NEXT_LINE +
                ...
                TAB + "Incomes" + NEXT_LINE +
                TAB + "1. salary - 100000 - " + TODAY.minusYears(1) +
                " - Recurring: YEARLY" + NEXT_LINE + TAB + "2. salary - 100000 - " + TODAY
